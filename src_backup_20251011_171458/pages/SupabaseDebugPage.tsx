            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex items-center">
                  <div
                    className={`flex-1 p-3 rounded border text-sm font-mono break-all ${
                      envVars.supabaseUrl
              ...
              <div>
                ...
                <div className="flex items-center">
                  ...
                  >
                    {envVars.supabaseAnonKey
                      ? `${envVars.supabaseAnonKey.substring(0, 20)}...`
                      : "NOT SET"}
                  </div>
                  {envVars.supabaseAnonKey && (
                    <button
                      onClick={() =>
                        handleCopy(envVars.supabaseAnonKey!, "key")
                      }
                      className="ml-2 p-2 text-neutral-500 hover:text-neutral-700 transition-colors"
                      title="Copy key"
                    >
          ...
          <div className="text-sm text-blue-700 space-y-3">
            <div>
              <p className="font-medium mb-2">
                1. If environment variables are missing or incorrect:
              </p>
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li>
                  Click the "Connect to Supabase" button in the top right of the
                  interface
                </li>
                <li>
                  Follow the setup wizard to configure your Supabase project
                </li>
                <li>
                  Make sure you're connecting to the correct Supabase project
                </li>
              </ul>
            </div>
            ...
            <div>
              <p className="font-medium mb-2">
                2. If you have the wrong database connected:
              </p>
              <ul className="list-disc list-inside ml-4 space-y-1">
                <li>
                ...
                <li>
                  Make sure you're in the correct project (check the project
                  name in the top left)
                </li>
                <li>
                  Copy the correct Project URL and anon key from Settings → API
                </li>
                <li>
                  Use the "Connect to Supabase" button to update your
                  configuration
                </li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="list-disc list-inside ml-4 space-y-1">
                ...
                <li>
                  Verify that the database tables exist (member_profiles, etc.)
                </li>
                <li>Ensure RLS policies are properly configured</li>
                <li>
                  Try the connection test page at <code>/connection-test</code>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="mt-8 bg-green-50 border border-green-200 rounded-lg p-6">
            ...
            <div className="text-sm text-green-700 space-y-2">
              <p>
                ...
                {connectionTest.healthCheck ? "Good" : "Unknown"}
              </p>
              <p>
                <strong>Current User:</strong>{" "}
                {connectionTest.user
                  ? connectionTest.user.email
                  : "Not logged in"}
              </p>
              <p>
                <strong>Tables Accessible:</strong>{" "}
                {connectionTest.tables ? "Yes" : "No"}
              </p>
              {connectionTest.tablesError && (
                <p>
                  <strong>Table Error:</strong> {connectionTest.tablesError}
                </p>
              )}
            </div>
          </div>
